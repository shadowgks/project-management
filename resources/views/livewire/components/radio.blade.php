<div class="form-check form-check-custom form-check-solid mb-5 {{ $class }}" {!! $_key == null ? '' : 'wire:key="' . $_key . '"' !!}>
    <input class="form-check-input {{ $inputClass }}" type="radio" {!! $_id == null ? '' : 'id="' . $_id . '"' !!} {!! $name == null ? '' : 'name="' . $name . '"' !!}
