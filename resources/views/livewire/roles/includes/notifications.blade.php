													...
													<div class="card pt-4 mb-6 mb-xl-9">
														...
														<div class="card-header border-0">
															...
															<div class="card-title flex-column">
																<span class="fw-bold mb-2 text-dark">{{ __('Notifications') }}</span>
																<span class="text-muted fw-semibold fs-7">Choose what notifications you’d like to receive .</span>
															...
															<form wire:submit.prevent="submit_permissions" method="POST">
																...
																<table class="table table-flush align-middle table-row-bordered table-row-solid gy-4 gs-9 border">
																	...
																	<tbody class="fw-6 fw-semibold text-gray-600">
																		...
																		@foreach ($notif_permissions as $key => $element)
