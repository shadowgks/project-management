                        ...
                        <div class="stepper-nav ps-lg-10">
                            <div class="stepper-item {{ $options['selected_step'] == 1 ? 'current' : '' }} {{ $options['selected_step'] > 1 ? 'completed' : '' }}"
                                ...
                                <div class="stepper-wrapper">
                                    ...
                                    <div class="stepper-label">
                                        ...
                                        <div class="stepper-desc">Choose List</div>
                                    </div>
                                </div>
                            ...
                            <div class="stepper-item {{ $options['selected_step'] == 2 ? 'current' : '' }} {{ $options['selected_step'] > 2 ? 'completed' : '' }}"
                                ...
                                <div class="stepper-wrapper">
                                    ...
                                    <div class="stepper-label">
                                        <h3 class="stepper-title">Filters</h3>
                                        <div class="stepper-desc">Create filters</div>
                                    </div>
                                </div>
                                <div class="stepper-line h-40px"></div>
                            </div>
                                ...
                                <div class="w-100">
                                    <div class="fv-row mb-10 fv-plugins-icon-container">
                                        ...
                                        @if ($options['user'] != null)
                                            <span class="text-primary"><span class="fw-bold">ID:</span>
                                                {{ $options['user']['id'] }}</span>
                                        @else
                                    ...
                                    <div class="fv-row">
                                        ...
                                        <select name="settings" class="form-select" id="settings"
                                            wire:model="values.setting_id" wire:change="get_setting">
                                            <option value=""></option>
                                            @foreach ($base_data['settings'] as $setting)
                                                <option value="{{ $setting['vid'] }}">{{ $setting['name'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="card-body p-0">
                                                            <div class="row">
                                                                ...
                                                                @if ($wh['type'] == 1)
                                                                    ...
                                                                    @if ($wh['column']['value'] != '')
                                                                        @if (in_array($wh['column']['type'], ['integer', 'float', 'double']) and !str_contains($wh['column']['value'], '_id'))
                                                                            <div class="col-md-6">
                                                                ...
                                                                @elseif ($wh['type'] == 2)
                                                                    <div class="col-md-12 row">
                                                                        ...
                                                                        <div
                                                                            class="col-md-6 d-flex flex-row align-items-end justify-content-end">
                                                                        ...
                                                                        <div class="col-md-12 row"
                                                                            ...
                                                                            <div class="col-md-6 pe-0">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    wire:key="filter-where-join-{{ $key }}-select-jtable-{{ $jkey }}"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <button type="button"
                                                                                    class="btn btn-sm btn-danger"
                                                                                    wire:key="filter-where-join-{{ $key }}-button-jtable-{{ $jkey }}"
                                                                        ...
                                                                        @if ($wh['data_type'] != 'normal')
                                                                            <div class="col-md-6">
                                                                                <label
                                                                                    ...
                                                                                    class="form-label">Operation</label>
                                                                                <select
                                                                                    name="filter-where-join-operation"
                                                                                    class="form-select"
