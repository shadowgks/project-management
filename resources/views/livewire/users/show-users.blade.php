                        ...
                        @foreach ($users as $key => $dt)
                            <tr>
                                <td class="fw-bold fs-6">
                                    <a href="{{ route('user.index', [$dt['id']]) }}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6" > {{ $dt['first_name'].' '.$dt['last_name'] }}</a>
                                ...
                                <td class="fw-bold fs-6">
                                    <button wire:click="edit_user({{ $dt['id'] }})" type="button" class="btn btn-secondary p-3 me-2">
                                        <i class="la la-edit p-0"></i>
                                    </button>
                                    <button wire:click="delete_user({{ $dt['id'] }})" type="button" class="btn btn-danger p-3 me-2">
