<x-base-layout>
    <div class="d-flex flex-column flex-lg-row">
        <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
            <x-card  :hastitle="false"  :hasfooter="false" bodyclass="p-10">
                    ...
                    <div class="mb-0">
                        ...
                        <div class="table-responsive mb-10">
                            ...
                            <table class="table g-5 gs-0 mb-0 fw-bold text-gray-700" data-kt-element="items">
                                ...
                                <!--begin::Table body-->
                                <tbody>
                                    <tr class="border-bottom border-bottom-dashed" style="border-bottom-color:#c0c1c3!important" data-kt-element="item">
                                        <td class="pe-7">
        ...
        <div class="flex-lg-auto min-w-lg-300px">
            ...
            <x-card :hastitle="false"  :hasfooter="false" bodyclass="p-10" data-kt-sticky="true" data-kt-sticky-name="invoice" data-kt-sticky-offset="{default: false, lg: '200px'}" data-kt-sticky-width="{lg: '250px', lg: '300px'}" data-kt-sticky-left="auto" data-kt-sticky-top="150px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95" >
                <div class="mb-10">
                    <!--begin::Label-->
