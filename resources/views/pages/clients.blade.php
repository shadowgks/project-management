<x-base-layout>
    ...
    <x-card :hastitle="true"  :hasfooter="false"  bodyclass="row" class="mb-6" >
                ...
                <div class="card-body d-flex align-items-end pt-0">
                    ...
                    <div class="d-flex align-items-center flex-column mt-3 w-100">
                        ...
                        <div class="h-8px mx-3 w-100 bg-white bg-opacity-50 rounded">
                            <div class="bg-white rounded h-8px" role="progressbar" style="width: 22%;" aria-valuenow="22" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                    <!--end::Progress-->
                </div>
        ...
        <div class="col-md-3">
            <div class="card card-flush bg-success" >
                ...
                <div class="card-header pt-5">
                    ...
                    <div class="card-title d-flex flex-column">
                        <!--begin::Amount-->
                        <span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">26</span>
                        <!--end::Amount-->
                        <!--begin::Subtitle-->
                        <span class="text-white opacity-75 pt-1 fw-semibold fs-6">Active Projects</span>
                        <!--end::Subtitle-->
                ...
                <div class="card-body d-flex align-items-end pt-0">
                    ...
                    <div class="d-flex align-items-center flex-column mt-3 w-100">
                        ...
                        <div class="h-8px mx-3 w-100 bg-white bg-opacity-50 rounded">
                            <div class="bg-white rounded h-8px" role="progressbar" style="width: 70%;" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                    <!--end::Progress-->
                </div>
            ...
            <div class="card card-flush bg-primary" >
                ...
                <div class="card-body d-flex align-items-end pt-0">
                    ...
                    <div class="d-flex align-items-center flex-column mt-3 w-100">
                        ...
                        <div class="h-8px mx-3 w-100 bg-white bg-opacity-50 rounded">
                            <div class="bg-white rounded h-8px" role="progressbar" style="width: 66%;" aria-valuenow="66" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                    <!--end::Progress-->
                </div>
            ...
            <div class="card card-flush bg-warning" >
                ...
                <div class="card-body d-flex align-items-end pt-0">
                    ...
                    <div class="d-flex align-items-center flex-column mt-3 w-100">
                        ...
                        <div class="h-8px mx-3 w-100 bg-white bg-opacity-50 rounded">
                            <div class="bg-white rounded h-8px" role="progressbar" style="width: 33%;" aria-valuenow="33" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                    <!--end::Progress-->
                </div>
    ...
    <x-card :hastitle="true"  :hasfooter="false" :addmodal="false" bodyclass="" >
        <x-slot name="headerContent">
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
            ...
            <tbody class="text-gray-600 fw-semibold">
                ...
                <tr>
                    ...
                    <!--begin::Action=-->
                    <td class="text-end">
                        <a href="#" class="btn btn-light btn-active-light-primary btn-sm"  data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                            <i class="lar la-edit"></i></a>
                        
                        <a href="#" class="btn btn-danger btn-active-light-primary btn-sm"  data-bs-toggle="tooltip" data-bs-placement="top" title="Delete">
